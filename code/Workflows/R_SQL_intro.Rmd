...
include_graphics("C:/Users/Kristen.Sauby/Documents/Projects/Data_Management_Workflows/R_SQL_Workflows/code/Workflows/Windows_search.png")
```

Type "odbc". An option should show up allowing you to click "ODBC Data Sources." Click it.

```{r, out.width="30%", echo=FALSE}
include_graphics("C:/Users/Kristen.Sauby/Documents/Projects/Data_Management_Workflows/R_SQL_Workflows/code/Workflows/odbc.png")
```
...
include_graphics("C:/Users/Kristen.Sauby/Documents/Projects/Data_Management_Workflows/R_SQL_Workflows/code/Workflows/drivers.png")
```
